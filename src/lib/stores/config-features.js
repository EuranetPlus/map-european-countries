export const config = {
	mapTitle: 'map-european-countries', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-european-countries.vercel.app', // The url provided when deploying the map on Vercel
